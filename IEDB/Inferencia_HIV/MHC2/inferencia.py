...
def main():
    ...
    print("Loading data...")
    try:
        allergic_sequences, allergic_labels = load_protein_sequences('simMHC2HIV.txt', 1)
        non_allergic_sequences, non_allergic_labels = load_protein_sequences('naoMHC2HIV.txt', 0)
